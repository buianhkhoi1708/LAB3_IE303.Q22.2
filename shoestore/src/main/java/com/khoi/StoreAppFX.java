...
public class StoreAppFX extends Application {
    ...
    static class Product {
        ...
        public Product(String name, String brand, String fullNote, String cardNote, String price, String imagePath) {
            this.name = name;
            this.brand = brand;
            this.fullNote = fullNote;
            this.cardNote = cardNote;
            this.price = price;
            // Load ảnh theo code của bạn
            this.image = new Image(getClass().getResourceAsStream("/images/" + imagePath));
        }
    }
    ...
    class LeftPanel extends VBox {
        ...
        public LeftPanel(Product product) {
            ...
            getChildren().addAll(imageView, separator, titleLabel, priceLabel, brandLabel, noteText);
        }
        ...
        public void updateProduct(Product product) {
            ...
            FadeTransition fade = new FadeTransition(Duration.millis(350), imageView);
    ...
    class ProductCard extends VBox {
        private static final String DEFAULT_STYLE = "-fx-background-color: #f3f3f3; -fx-background-radius: 8; -fx-border-color: transparent; -fx-border-width: 1.5; -fx-border-radius: 8;";

        private static final String SELECTED_STYLE = "-fx-background-color: #ffffff; -fx-background-radius: 8; -fx-border-color: #8cb4f8; -fx-border-width: 1.5; -fx-border-radius: 8;";
        ...
        public ProductCard(Product product) {
            ...
            noteLabel.setFont(Font.font("Arial", FontWeight.BOLD, 11));
            ...
            getChildren().addAll(nameLabel, noteLabel, imgContainer, bottomPane);
            VBox.setVgrow(imgContainer, Priority.ALWAYS);
        }

        private boolean isSelected() {
            return getStyle().equals(SELECTED_STYLE);
        }
    ...
    private List<Product> createSampleData() {
        ...
        list.add(new Product("4DFWD PULSE SHOES", "Adidas", exclusionFull, exclusionShort, "$160.00", "img1.png"));
        list.add(new Product("FORUM MID SHOES", "Adidas", exclusionFull, exclusionShort, "$100.00", "img2.png"));
        list.add(new Product("SUPERNOVA SHOES", "Adidas", "NMD City Stock 2", "NMD City Stock 2", "$150.00", "img3.png"));
        list.add(new Product("NMD City Stock 2", "Adidas", "NMD City Stock 2", "NMD City Stock 2", "$160.00", "img4.png"));
        list.add(new Product("4DFWD PULSE SHOES", "Adidas", exclusionFull, exclusionShort, "$160.00", "img5.png"));
        list.add(new Product("FORUM MID SHOES", "Adidas", exclusionFull, exclusionShort, "$120.00", "img6.png"));
        list.add(new Product("4DFWD PULSE SHOES", "Adidas", exclusionFull, exclusionShort, "$160.00", "img1.png"));
        list.add(new Product("FORUM MID SHOES", "Adidas", exclusionFull, exclusionShort, "$100.00", "img2.png"));
